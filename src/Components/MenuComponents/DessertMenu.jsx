...
const DessertMenu = ({desserts}) => {
    return (
        <div className="mb-20">
            <Cover bg_img={image} title={"DESSERTS"} description={"Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."}></Cover>
           <div className="grid md:grid-cols-2 gap-5">
           {
           desserts.map(menu=><MenuItem key={menu._id} menu={menu}></MenuItem>)
           }
           </div>
